...
- Active control step: S09 accepted (2026-08-20); next unit S10
- Next implementation unit: S10 (OpenAI Responses API and structured outputs - includes the GLM compatibility fix from D014) - not yet started
...
- Offline demo path: Available through deterministic mode (smoke + pytest pass; 176 tests; ruff clean; AppTest shell loads; Postgres tests skip cleanly when the DB is down)
