...
- Active control step: S08 accepted (2026-08-20); next unit S09
- Next implementation unit: S09 (Deterministic Reference Simulator) - not yet started
...
- Offline demo path: Available through deterministic mode (smoke + pytest pass; 23 tests; ruff clean; AppTest shell loads; Postgres tests skip cleanly when the DB is down)
